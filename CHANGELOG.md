...
# 2.89.x
* Bump Roslyn (version unresolved) (PR: [#26](https://github.com/deepakrathore33/test-github-actions/pull/26))
  ...
  * Reorder checks to report issue as early as possible (PR: [#79915](https://github.com/dotnet/roslyn/pull/79915))
  * Update localization branch to 17.14 (PR: [#79918](https://github.com/dotnet/roslyn/pull/79918))
  * Avoid crash from Script class instantiation (PR: [#79879](https://github.com/dotnet/roslyn/pull/79879))
  * Unblock type forwarding scenarios involving extensions (PR: [#79905](https://github.com/dotnet/roslyn/pull/79905))
  * Fix nullable annotations of `SymbolDisplay.FormatPrimitive` (PR: [#79869](https://github.com/dotnet/roslyn/pull/79869))
  * Extensions: Address follow-ups related to collection expressions (PR: [#79877](https://github.com/dotnet/roslyn/pull/79877))
  * Block ENC for extension blocks (PR: [#79883](https://github.com/dotnet/roslyn/pull/79883))
  * [main] Source code updates from dotnet/dotnet (PR: [#79889](https://github.com/dotnet/roslyn/pull/79889))
  ...
  * Reenable/Fix integration test reporting (PR: [#79789](https://github.com/dotnet/roslyn/pull/79789))
  * Update checklist for adding new language version (PR: [#79881](https://github.com/dotnet/roslyn/pull/79881))
  * Don't try to load file based projects unless we get a .cs file (PR: [#79844](https://github.com/dotnet/roslyn/pull/79844))
  * Workaround VSCode's lack of support for case sorting in completion (PR: [#79772](https://github.com/dotnet/roslyn/pull/79772))
  * Disable incremental binary analysis to workaround duplicate VSSetup artifacts (PR: [#79839](https://github.com/dotnet/roslyn/pull/79839))
  * More semantic update changes (PR: [#79828](https://github.com/dotnet/roslyn/pull/79828))
  * Fix flow analysis of extern local functions (PR: [#79741](https://github.com/dotnet/roslyn/pull/79741))
  * Allow using `/main` with top-level statements (PR: [#79577](https://github.com/dotnet/roslyn/pull/79577))
  * Compute diagnostic descriptor info in OOP process (PR: [#79812](https://github.com/dotnet/roslyn/pull/79812))
  * Update new IDiagnosticAnalyzerService methods to be async. (PR: [#79809](https://github.com/dotnet/roslyn/pull/79809))
  * Remove analyzer cache from public surface area (PR: [#79808](https://github.com/dotnet/roslyn/pull/79808))
  * Fix issue where analyzers are missing when computing diagnostics OOP (PR: [#79821](https://github.com/dotnet/roslyn/pull/79821))
  * Merge `features/extensions` into `main` branch (PR: [#79860](https://github.com/dotnet/roslyn/pull/79860))
  * Merge latest bits from `main` into `features/extensions` (PR: [#79858](https://github.com/dotnet/roslyn/pull/79858))
  * Rewrite method infos earlier in ref safety analysis (PR: [#79447](https://github.com/dotnet/roslyn/pull/79447))
  * Add messages for when design time builds begin and complete (PR: [#79669](https://github.com/dotnet/roslyn/pull/79669))
  * Extensions: change naming convention and update attribute name (PR: [#79829](https://github.com/dotnet/roslyn/pull/79829))
  * Loosen casting requirements on switch expression conversion (PR: [#77139](https://github.com/dotnet/roslyn/pull/77139))
  * Fix issue where PopulateSwitch would suggest populating already exhaustive switch expressions (PR: [#79850](https://github.com/dotnet/roslyn/pull/79850))
  * Do not use .GetHashCode in .Equals impl (PR: [#79849](https://github.com/dotnet/roslyn/pull/79849))
  * Offer wrap parameters in primary constructor base call (PR: [#79848](https://github.com/dotnet/roslyn/pull/79848))
  * Fix renaming of locals in source generated documents (PR: [#79838](https://github.com/dotnet/roslyn/pull/79838))
  * ExtensionGroupingInfo - reduce consumed memory and delay creation of Cci adapter instances until emit (PR: [#79755](https://github.com/dotnet/roslyn/pull/79755))
  * Extensions: check for collisions (PR: [#79702](https://github.com/dotnet/roslyn/pull/79702))
  * Add LanguageVersion for C# 14 (PR: [#79725](https://github.com/dotnet/roslyn/pull/79725))
  * Fix invalid link to Analyzer Configuration.md (PR: [#79827](https://github.com/dotnet/roslyn/pull/79827))
  * Remove lazy enumerables (PR: [#79776](https://github.com/dotnet/roslyn/pull/79776))
  * Use Linq helpers. (PR: [#79775](https://github.com/dotnet/roslyn/pull/79775))
  * Extensions: address follow-ups for new metadata design (PR: [#79674](https://github.com/dotnet/roslyn/pull/79674))
  * Extensions: update xml docs to new metadata design (PR: [#79641](https://github.com/dotnet/roslyn/pull/79641))
  * Adjust visibility of extension marker method in metadata once more (PR: [#79617](https://github.com/dotnet/roslyn/pull/79617))
  * Fix receiver capturing for various extension scenarios (PR: [#79472](https://github.com/dotnet/roslyn/pull/79472))
  * Adjust visibility of extension marker method in metadata (PR: [#79583](https://github.com/dotnet/roslyn/pull/79583))
  * Delay MatchesContainingTypeParameters check for extensions loaded from metadata (PR: [#79588](https://github.com/dotnet/roslyn/pull/79588))
  * Move to new metadata format for extensions (PR: [#79553](https://github.com/dotnet/roslyn/pull/79553))
  * Merge 'main' into 'extensions' (PR: [#79485](https://github.com/dotnet/roslyn/pull/79485))
